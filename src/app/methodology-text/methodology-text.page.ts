...
export class MethodologyTextPage implements OnInit {
  ...
  mapThermometer(value) {
    switch (value) {
      case '1': {
        this.thermometer = 'O grau de evidência é muito baixo';
        this.thermometer_color = '#cedaed';
        break;
      }
      case '2': {
        this.thermometer = 'O grau de evidência é baixo';
        this.thermometer_color = '#cee5ed';
        break;
      }
      case '3': {
        this.thermometer = 'O grau de evidência é médio';
        this.thermometer_color = '#ffffc6';
        break;
      }
      case '4': {
        this.thermometer = 'O grau de evidência é alto';
        this.thermometer_color = '#ffdcc6';
        break;
      }
      case '5': {
        this.thermometer = 'O grau de evidência é muito alto';
